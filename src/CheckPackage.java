...
public class CheckPackage extends JFrame {
    CheckPackage() {
        ...
        String[] package1 = new String[] { "GOLD PACKAGE", "6 days and 7 Nights ", "Airport Assistance",
                ...
                " English Speaking Guide", " BOOK NOW", " SUMMER SPECIAL", " Rs 32000/-", "package1.jpg" };
        String[] package2 = new String[] { "SILVER PACKAGE", "5 days and 6 Nights ",
                "Toll Free and Entrace Free Tickets ", "Meet and Greet at Airport", " Welcome Drinks at Arrival",
        ...
        String[] package3 = new String[] { "BRONZE PACKAGE", "6 days and 5 Nights ", "Return Airfare ",
                "Free Horse Riding & other Games", " Welcome Drinks at Arrival ", " Daily Buffet",
                " Stay in Five Star Hotel", "BBQ Dinner", " BOOK NOW", " WINTER SPECIAL", " Rs 12000/-",
                "package3.jpg" };
